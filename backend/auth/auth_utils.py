...
def create_preauth_token(user_id: int):
    ...
    # Dodajemy unikalny "type", żeby ktoś nie użył tego tokena jako zwykłego access_token
...
def create_refresh_token(data: dict):
    ...
    # KRYTYCZNE: Dodajemy "type": "refresh", aby nikt nie użył tego tokena
    # jako zwykłego access_tokena dostępowego!
